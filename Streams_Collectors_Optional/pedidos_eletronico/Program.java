...
public class Program {
        public static void main(String[] args) {
                ...
                List<Pedido> pedidosEletronicos1 = Consulta.obterPedidosComEletronicos(List.of(pedido1, pedido2, pedido3));
                List<Pedido> pedidosEletronicos2 = Consulta.obterPedidosComEletronicos(List.of(pedido2, pedido3));
                List<Pedido> pedidosEletronicos3 = Consulta.obterPedidosComEletronicos(List.of(pedido3));
                List<Pedido> pedidosEletronicos4 = Consulta.obterPedidosComEletronicos(List.of(pedido4));

                System.out.println(pedidosEletronicos1.toString());
